...
HD_PWD='C:/Users/ethan/Documents/GitHub/ECE385FinalProject/FPGA/vivadoproject/vivadoproject.runs/bram3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram3.tcl
