...
HD_PWD='C:/Users/ethan/Documents/GitHub/ECE385FinalProject/FPGA/vivadoproject/vivadoproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TrackerTopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TrackerTopLevel.tcl
