...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../vivadoproject.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../vivadoproject.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../vivadoproject.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../vivadoproject.gen/sources_1/bd/design_1/ipshared/7698" \
       -input simulate.do
}
