...
#
# Generated by export_simulation on Sun Nov 17 20:02:54 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './bram3.sh' script.
...
./bram3.sh -noclean_files

For more information on the script, please type './bram3.sh -help'.
