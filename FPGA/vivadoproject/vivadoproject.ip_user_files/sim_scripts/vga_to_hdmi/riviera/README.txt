...
#
# Generated by export_simulation on Thu Nov 14 16:28:41 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './vga_to_hdmi.sh' script.

./vga_to_hdmi.sh -reset_run
...
./vga_to_hdmi.sh -noclean_files

For more information on the script, please type './vga_to_hdmi.sh -help'.
